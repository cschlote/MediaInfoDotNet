namespace MediaInfoDotNet.WFClient
{
	partial class UserControlStreamsViewer
	{
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UserControlStreamsViewer));
			...
			this.bsCollection.CurrentChanged += new System.EventHandler(this.bsCollection_CurrentChanged);
			// 
			// bindingNavigator1
			// 
			this.bindingNavigator1.AddNewItem = this.bindingNavigatorAddNewItem;
			this.bindingNavigator1.AllowDrop = true;
			this.bindingNavigator1.BindingSource = this.bsCollection;
